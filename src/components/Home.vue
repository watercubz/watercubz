          ...
          <div class="relative h-full ml-0 mr-0 sm:mr-10">
            ...
            >
              ...
              <p class="mb-2 text-gray-600">
                I am a software developer with an interest in backend
                development and with knowledge in Javascript experience in
                frameworks Express Nodejs MongoDB Supabase PostgreSQL
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="flex flex-col w-full mb-5 sm:flex-row">
        <div class="w-full mb-10 sm:mb-0 sm:w-1/2">
          <div class="relative h-full ml-0 mr-0 sm:mr-10">
            ...
            >
              ...
              <p class="mb-2 text-gray-600">
                   I've undertaken personal projects, freelancing gigs, and hackathons, significantly advancing my skills. While I've used frontend libraries like Next.js, my expertise lies in backend development. Explore my diverse projects on GitHub.
                </p>
            </div>
          </div>
        </div>
        <div class="w-full mb-10 sm:mb-0 sm:w-1/2">
          <div class="relative h-full ml-0 mr-0 sm:mr-10">
            ...
            <ul class="space-y-2">
            <li>
              <a href="https://github.com/watercubz" target="_blank" class="flex items-center space-x-2">
            ...
            <li>
              <a href="https://www.instagram.com/watercubz" target="_blank" class="flex items-center space-x-2">
                <img src="https://cdn-icons-png.flaticon.com/512/174/174855.png" alt="Instagram" class="w-6 h-6">
                <span>Instagram</span>
              </a>
            </li>
            </ul>
        ...
        <div class="w-full sm:w-1/2">
          <div class="relative h-full ml-0 md:mr-10">
            ...
            >
              ...
              <p class="mb-2 text-gray-600">
               "Crafting elegant solutions one line of code at a time, building tomorrow's innovations today." ❤️
              </p>
            </div>
          </div>
        </div>
